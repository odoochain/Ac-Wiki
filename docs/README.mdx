...
- ✅ [**学生优惠**](Computer/general-skills/student-discounts.md)
- 🚧 **编程 / 开发 / 新质生产力**
...
- ✅ [国家助学贷款（常见问题）](Life/campus-life/national-student-loan-FAQ.md)
- 🚧 大学生创业扶持

### 🏫 校园生活

- ✅ [开学第 0 课](Life/campus-life/01-FirstLesson-Of-School.md)（宿舍购置物品/所学专业的培养计划/绩点、学分计算方式/大学课表工作方式（常用课表软件））
- ✅ [选修课/必修课/兴趣（个性化）课/网络课程](Life/campus-life/02-Different-Courses.md)
- ✅ [签到考勤](Life/campus-life/03-Signin-And-Attendance.md)
- ✅ [转专业须知](Life/campus-life/04-Changing-Majors.md)
- ✅ [辅修/第二学位须知](Life/campus-life/05-Minor.md)
- ✅ [如何申请学生邮箱](Life/campus-life/06-Student-Email.md)
- ✅ [图书馆](Life/campus-life/07-Library.md)
- ✅ [化解矛盾](Life/campus-life/08-Resolving-Conflicts.md)
- ✅ [人际关系](Life/campus-life/09-Relation-Ships.md)
- ✅ [脱单技巧](Life/campus-life/10-Getting-Out-Of-Singleness.md)
- ✅ [国际交流项目指南](Life/campus-life/12-International-Exchange.md)
- ✅ [大学生医保使用指南](Life/campus-life/11-Medical-Insurance.md)
...
- ✅ [**高效检索信息/获取资源**](Computer/general-skills/search-platforms.md)
- 🚧 **第一篇论文**
  - 🚧 学术规范与学术不端行为解释
  - 🚧 论文是什么，有哪些分类
  - 🚧 正确设置格式
...
- ✅ [**计算机基础技能**](Computer/computer-basic/SurfingTutorial.md)
- 🚧 **运用新质生产力**
- 🚧 **合理规划时间**
- 🚧 **高效学习技巧**
...
- 🚧 **获取资源**
- ✅ [**效率优化**](Computer/tools/tools.md)
- 🚧 **学术网站**
- 🚧 **数据检索**

#### 🔒 网络安全

- ✅ [密码管理](Computer/tools/password_manage.md)
<!--- ✅ [账号安全](./tools/cyber%20security/Authenticator.md) --->
- ✅ [隐私保护](Computer/tools/cyber%20security/privacy.md)

#### 🏃 校园应用

- ✅ [**风驰电掣**](Computer/tools/qi-ji-yin-qiao/campus-running.md)
- ✅ [**珍惜时间**](Computer/tools/qi-ji-yin-qiao/pointless-courses.md)

### 🏆 考赛介绍

- 🚧 **学科等级**
- ✅ [**专业技能**](Computer/study/certification.md)
- ✅ [**考试竞赛**](Computer/study/study.md)
- ✅ [**研招**](Computer/study/yanzhao.md)
- ✅ [**生化/环境/材料专业指南**](Computer/study/biochem-env-materials-guide.md)
